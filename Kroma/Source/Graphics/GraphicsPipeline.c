...
SDL_GPUGraphicsPipeline *graphics_pipeline_create(SDL_GPUDevice *device, GraphicsPipelineDescription *desc)
{
    ...
    color_target_description.blend_state.color_write_mask = SDL_GPU_COLORCOMPONENT_R | SDL_GPU_COLORCOMPONENT_G | SDL_GPU_COLORCOMPONENT_B | SDL_GPU_COLORCOMPONENT_A;
